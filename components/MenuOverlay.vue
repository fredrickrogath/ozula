<template>
    <div id="MenuOverlay" class="fixed z-50 bottom-0 h-full w-full bg-white">
        <div class="flex items-center justify-between px-3 py-3">
            ...
            <button 
                ...
                class="rounded-full p-1 hover:text-gray-200"
            >
            ...
            <ul class="w-full">
                ...
                >
                    <div class=" flex items-center text-[20px]">
                        <Icon name="ph:pen-light" size="25"/>
                ...
                >
                    <div class=" flex items-center text-[20px]">
                        <Icon name="ph:shopping-cart-simple-light" size="25"/>
                ...
                >
                    <div class=" flex items-center text-[20px]">
                        <Icon name="ph:sign-out-light" size="25"/>
                ...
                >
                    <div class=" flex items-center text-[20px]">
                        <Icon name="ph:sign-in-light" size="25"/>
