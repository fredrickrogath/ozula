<template>
  <div class="sticky top-[100vh]">
    <div id="FooterMain" class="w-full bg-[#333333] mt-10 pb-2">
      <div class="max-w-[1200px] mx-auto px-4">
        <div class="md:flex gap-4 justify-between w-full">
          <div class="md:w-[50%] pt-4">
            <div class="text-lg font-semibold text-[#999999]">Help</div>
          ...
          <div class="md:w-[50%] pt-4">
            <div class="text-lg font-semibold text-[#999999]">
              Browse by Category
            </div>
            <div class="text-[#999999] text-sm">
              All Popular, Product, Promotion, Low Price, Great Value, Reviews,
              Blog, Seller Portal, BLACK FRIDAY, Ozula Assistant
            </div>
          </div>
        </div>
        ...
        <!-- <div class="md:flex gap-4 justify-between w-full">
          <div class="md:w-[50%] pt-4">
            <div class="text-lg font-semibold text-[#282828]">
              Browse by Category
            </div>
            <div class="text-[#999999] text-sm">
              All Popular, Product, Promotion, Low Price, Great Value, Reviews,
    ...
    <div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400">
      <div class="max-w-[1200px] mx-auto p-4">
        ...
        - Information for Consumers - Transaction Services Agreement - User
        Information Legal Enquiry Guide ©️2024 Ozuna. All rights reserved. Ozuna
        is a registered company in Dar es Salaam, Tanzania. License Number: [Your
        License Number]
      </div>
    </div>
  </div>
